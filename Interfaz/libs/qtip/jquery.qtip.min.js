...
! function (a, b, c) {
    ! function (a) {
        ...
        function n(a) {
            return this.tooltip.hasClass($) ? D : (clearTimeout(this.timers.show), clearTimeout(this.timers.hide), this.timers.show = m.call(this, function () {
                this.toggle(C, a)
            }, this.options.show.delay), void 0)
        }

        function o(a) {
            if (this.tooltip.hasClass($)) return D;
        ...
        function p(a) {
            return this.tooltip.hasClass($) || !this.options.hide.inactive ? D : (clearTimeout(this.timers.inactive), this.timers.inactive = m.call(this, function () {
                this.hide(a)
        ...
        function r(a, c, e) {
            d(b.body).delegate(a, (c.split ? c : c.join(fb + " ")) + fb, function () {
        ...
        function s(a, c, f) {
            ...
            return a.attr(R, c), k.suppress && (l = a.attr("title")) && a.removeAttr("title").attr(ab, l).attr("title", ""), g = new e(a, k, c, !!j), a.data(Q, g), a.one("remove.qtip-" + c + " removeqtip.qtip-" + c, function () {
                var a;
                (a = d(this).data(Q)) && a.destroy(!0)
            }), g
        }
        ...
        y = e.prototype, y._when = function (a) {
            ...
            return d.attr(this.target[0], "aria-describedby", this._id), this.tooltip = g.tooltip = b = d("<div/>", {
                id: this._id,
                "class": [Q, X, e.style.classes, Q + "-pos-" + e.position.my.abbrev()].join(" "),
                width: e.style.width || "",
                ...
                id: this._id + "-content",
                "aria-atomic": C
            })), this.rendered = -1, this.positioning = C, i && (this._createTitle(), d.isFunction(i) || l.push(this._updateTitle(i, D))), j && this._createButton(), d.isFunction(h) || l.push(this._updateContent(h, D)), this.rendered = C, this._setWidget(), d.each(P, function (a) {
                var b;
            ...
            function b() {
                if (!this.destroyed) {
                    ...
                    }), clearTimeout(this.timers.show), clearTimeout(this.timers.hide), this._unassignEvents(), a.removeData(Q).removeAttr(S).removeAttr(R).removeAttr("aria-describedby"), this.options.suppress && b && a.attr("title", b).removeAttr(ab), this._unbind(a), this.options = this.elements = this.cache = this.timers = this.plugins = this.mouse = E, delete x.api[this.id]
                }
            }
        ...
        y.set = function (a, b) {
            ...
            return "string" == typeof a ? (c = a, a = {}, a[c] = b) : a = d.extend({}, a), d.each(a, function (b, c) {
                if (e && db.test(b)) return delete a[b], void 0;
            ...
            if (d.isArray(k) && 2 === k.length) m = {
                ...
                k[0] === b || k[0] === a ? (t = bb.iOS ? a.innerWidth : k.width(), u = bb.iOS ? a.innerHeight : k.height(), k[0] === a && (w = {
                    top: (n || k).scrollTop(),
                    left: (n || k).scrollLeft()
                })) : P.imagemap && k.is("area") ? f = P.imagemap(this, k, m, P.viewport ? q : D) : P.svg && k && k[0].ownerSVGElement ? f = P.svg(this, k, m, P.viewport ? q : D) : (t = k.outerWidth(D), u = k.outerHeight(D), w = k.offset()), f && (t = f.width, u = f.height, g = f.offset, w = f.position), w = this.reposition.offset(k, w, o), (bb.iOS > 3.1 && bb.iOS < 4.1 || bb.iOS >= 4.3 && bb.iOS < 4.33 || !bb.iOS && "fixed" === v) && (w.left -= z.scrollLeft(), w.top -= z.scrollTop()), (!f || f && f.adjustable !== D) && (w.left += m.x === M ? t : m.x === N ? t / 2 : 0, w.top += m.y === L ? u : m.y === N ? u / 2 : 0)
            }
            return w.left += p.x + (l.x === M ? -r : l.x === N ? -r / 2 : 0), w.top += p.y + (l.y === L ? -s : l.y === N ? -s / 2 : 0), P.viewport ? (w.adjusted = P.viewport(this, w, j, t, u, r, s), g && w.adjusted.left && (w.left += g.left), g && w.adjusted.top && (w.top += g.top)) : w.adjusted = {
                left: 0,
                top: 0
        ...
        var eb = (z = y.reposition.Corner = function (a, b) {
        ...
        var fb = "." + Q;
        d(function () {
            r(U, ["mouseenter", "mouseleave"], function (a) {
                var b = "mouseenter" === a.type,
                    c = d(a.currentTarget),
                    e = d(a.relatedTarget || a.target),
                    f = this.options;
                b ? (this.focus(a), c.hasClass(W) && !c.hasClass($) && clearTimeout(this.timers.hide)) : "mouse" === f.position.target && f.hide.event && f.show.target && !e.closest(f.show.target[0]).length && this.hide(a), c.toggleClass(Z, b)
            }), r("[" + S + "]", V, p)
            ...
            return !arguments.length && k || "api" === f ? k : "string" == typeof a ? (this.each(function () {
                ...
                var b, c;
                return c = d.isArray(k.id) ? k.id[a] : k.id, c = !c || c === D || c.length < 1 || x.api[c] ? x.nextid++ : c, b = s(d(this), c, k), b === D ? C : (x.api[c] = b, d.each(P, function () {
        ...
        }), x.version = "2.2.0", x.nextid = 0, x.inactiveEvents = V, x.zindex = 15e3, x.defaults = {
            prerender: D,
            id: D,
            overwrite: C,
            suppress: C,
        ...
        var gb, hb = "margin",
            ...
            pb = {},
            qb = ["Webkit", "O", "Moz", "ms"];
        if (nb) var rb = a.devicePixelRatio || 1,
            sb = function () {
                var a = b.createElement("canvas").getContext("2d");
                return a.backingStorePixelRatio || a.webkitBackingStorePixelRatio || a.mozBackingStorePixelRatio || a.msBackingStorePixelRatio || a.oBackingStorePixelRatio || 1
            }(),
            tb = rb / sb;
        else var ub = function (a, b, c) {
        ...
        d.extend(w.prototype, {
            init: function (a) {
                ...
                c = this.element = a.elements.tip = d("<div />", {
                    "class": Q + "-tip"
                }).prependTo(a.tooltip), nb ? (b = d("<canvas />").appendTo(this.element)[0].getContext("2d"), b.lineJoin = "miter", b.miterLimit = 1e5, b.save()) : (b = ub("shape", 'coordorigin="0,0"', "position:absolute;"), this.element.html(b + b), a._bind(d("*", c).add(c), ["click", "mousedown"], function (a) {
                    a.stopPropagation()
            ...
            _parseRadius: function (a) {
                var b = this.qtip.elements,
                    c = ib + t(a.y) + t(a.x) + "Radius";
                return bb.ie < 9 ? 0 : v(this._useTitle(a) && b.titlebar || b.content, c) || v(b.tooltip, c) || 0
            },
            ...
            create: function () {
                var a = this.corner = (nb || bb.ie) && this._parseCorner(this.options.corner);
            ...
            reposition: function (a, b, d) {
                ...
                if (this.enabled) {
                    var g, h, i = b.cache,
                        ...
                        p = {};
                    this.corner.fixed !== C && (e(m, F, G, K, M), e(n, G, F, J, L), j.string() === i.corner.string() || i.cornerTop === k.top && i.cornerLeft === k.left || this.update(j, D)), g = this.calculate(j), g.right !== c && (g.left = -g.right), g.bottom !== c && (g.top = -g.bottom), g.user = this.offset, (o.left = m === O && !!k.left) && f(F, K, M), (o.top = n === O && !!k.top) && f(G, J, L), this.element.css(p).toggle(!(o.x && o.y || j.x === N && o.y || j.y === N && o.x)), d.left -= g.left.charAt ? g.user : m !== O || o.top || !o.left && !o.top ? g.left + this.border : 0, d.top -= g.top.charAt ? g.user : n !== O || o.left || !o.left && !o.top ? g.top + this.border : 0, i.cornerLeft = k.left, i.cornerTop = k.top, i.corner = j.clone()
                }
            },
            destroy: function () {
            ...
            polygon: function (a, b) {
                ...
                if (d = f.width = Math.abs(f.position.right - f.position.left), e = f.height = Math.abs(f.position.bottom - f.position.top), "c" === b.abbrev()) f.position = {
                    ...
                    for (; d > 0 && e > 0 && i > 0 && j > 0;)
                        for (d = Math.floor(d / 2), e = Math.floor(e / 2), b.x === K ? i = d : b.x === M ? i = f.width - d : i += Math.floor(d / 2), b.y === J ? j = e : b.y === L ? j = f.height - e : j += Math.floor(e / 2), g = h.length; g-- && !(h.length < 2);) k = h[g][0] - f.position.left, l = h[g][1] - f.position.top, (b.x === K && k >= i || b.x === M && i >= k || b.x === N && (i > k || k > f.width - i) || b.y === J && l >= j || b.y === L && j >= l || b.y === N && (j > l || l > f.height - j)) && h.splice(g, 1);
                    f.position = {
                        left: h[0][0],
                        top: h[0][1]
                    }
            ...
            ellipse: function (a, b, c, d, e) {
                var f = P.polys._angles[e.abbrev()],
            ...
            case "ellipse":
            case "circle":
                o = P.polys.ellipse(r.cx.baseVal.value, r.cy.baseVal.value, (r.rx || r.r).baseVal.value + w, (r.ry || r.r).baseVal.value + w, e);
                break;
            case "line":
            case "polygon":
            case "polyline":
                for (n = r.points || [{
                    x: r.x1.baseVal.value,
                    y: r.y1.baseVal.value
                }, {
